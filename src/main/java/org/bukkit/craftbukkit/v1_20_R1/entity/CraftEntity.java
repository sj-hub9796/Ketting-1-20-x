            ...
            // Water Animals
                ...
                // Monsters
                    ...
                    if (entity instanceof net.minecraft.world.entity.monster.Zombie) {
                        ...
                        else return new CraftCustomAbstractSkeleton(server, (net.minecraft.world.entity.monster.AbstractSkeleton) entity); //Ketting
                    }
                    ...
                    else if (entity instanceof net.minecraft.world.entity.raid.Raider) { return new CraftCustomRaider(server, (net.minecraft.world.entity.raid.Raider) entity); } //Ketting
